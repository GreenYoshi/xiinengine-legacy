	...
	class XiinEngine
	{
		...
		public function start()
		{
			...
			{			
				...
				else if ($input[0] == "uploader")
					$theme = $this->loadTheme("uploader");
				else
		...
		{			
			...
			try
			{
				...
				{
					// File is missing, load 404 class
					
					//throw new Exception("File not readable");
					include SysPagePath . "404/class.php";
					$pageClass = $this->loadClass("pages","404","page");	
					$pageClass->runPage("File not readable: $path");
					return $pageClass;								
				}
			}
			catch (Exception $e) {
		...
		private function doAuth()
		{
			...
			session_start();
			if(isset($_SESSION["xe_userIsAdmin"]))
			{
