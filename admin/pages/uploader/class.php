 ...
 * @since v1.2
 */   
class page_uploader extends XePage
{
    private $bodyData;
    private $titleData;
    private $metaData;
    ...
    public function getTitle()
    {
        if (isset($this->titleData))
            ...
            return "XE Uploader";  // We accept empty titles
    }
	...
	public function generateForm($perm,$permid,$formAction)
	{
		...
		$formOutput .= $formObject->row('Permission Name',
										'Visual name of the permission',
										'text',
										'PermAccessName',
										$this->perm['PermAccessName']
										);
		$formOutput .= $formObject->row('Hexadecimal Color',
										'Giving access to modify this only by ROOT account',
										'text',
										'PermHexColor',
										$this->perm['PermHexColor']
										);
