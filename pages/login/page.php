 ...
 * @since v1.2
 */   
$this->titleData = XE_SITE_NAME.' | Login';
...
<div id="login_container">
    <div class="login_labels">
        <?php
			if (sysDebugMode || sysMaintenanceMode || !XiinEngine::$siteConfig->sitePublicEnabled)
			{
				...
				if (!XiinEngine::$siteConfig->sitePublicEnabled)
				{
					if (sysMaintenanceMode || sysDebugMode)
						$outString .= "<br />";
					else
						$outString = "";
					$outString .= XiinEngine::$siteConfig->sitePublicClosedMsg;
				}
